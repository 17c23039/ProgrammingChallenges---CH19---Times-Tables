...
print("Here is the full set of times tables for the number you entered:")
print(num * 1)
time.sleep(1)
print(num * 2)
time.sleep(1)
...
print(num * 12)
time.sleep(1)
print("Thanks for showing your enthusiasm towards maths! I'll see ya soon, buh bye!")